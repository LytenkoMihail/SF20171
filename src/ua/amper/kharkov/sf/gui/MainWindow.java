...
import static ua.amper.kharkov.sf.SFConstants.EXIT_THE_PROGRAM;
    ...
    public MainWindow(OptionsWindow WO) {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                int res = JOptionPane.showConfirmDialog(e.getWindow(), EXIT_THE_PROGRAM, SFConstants.SF_VERSION, JOptionPane.YES_OPTION);
